require('dotenv').config();const Web3 = require('web3');const axios = require('axios');

// Configurationconst BSC_RPC_URL = process.env.BSC_RPC_URL;const ORACLE_PRIVATE_KEY = process.env.ORACLE_PRIVATE_KEY;const PRE_SALE_ADDRESS = process.env.PRE_SALE_ADDRESS;       // TODO: set actual Pre-Sale contract addressconst PUBLIC_SALE_ADDRESS = process.env.PUBLIC_SALE_ADDRESS; // TODO: set actual Public Sale contract address

// Initialize Web3 and Oracle accountconst web3 = new Web3(new Web3.providers.HttpProvider(BSC_RPC_URL));const oracleAccount = web3.eth.accounts.privateKeyToAccount(ORACLE_PRIVATE_KEY);web3.eth.accounts.wallet.add(oracleAccount);web3.eth.defaultAccount = oracleAccount.address;

// ABI definitions for required contract functions and eventsconst preSaleAbi = [// Oracle-called functions{ "inputs": [{ "internalType": "uint256", "name": "_bnbPrice", "type": "uint256" }], "name": "updateBNBPrice", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{ "inputs": [{ "internalType": "uint256", "name": "_stageId", "type": "uint256" }], "name": "closeStageByOracle", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{ "inputs": [], "name": "triggerWhitelistOpen", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{ "inputs": [], "name": "triggerWhitelistClose", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{ "inputs": [], "name": "triggerB100DStart", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{ "inputs": [], "name": "triggerDailyB100DPayout", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{ "inputs": [], "name": "distributeFunds", "outputs": [], "stateMutability": "nonpayable", "type": "function" },

// View functions{ "inputs": [], "name": "currentStageId", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{"inputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],"name": "stages","outputs": [{ "internalType": "uint256", "name": "tokensAvailable", "type": "uint256" },{ "internalType": "uint256", "name": "tokenPrice", "type": "uint256" },{ "internalType": "uint256", "name": "bonusPercent", "type": "uint256" },{ "internalType": "uint256", "name": "tokensSold", "type": "uint256" },{ "internalType": "uint256", "name": "duration", "type": "uint256" },{ "internalType": "uint256", "name": "startTime", "type": "uint256" },{ "internalType": "bool", "name": "isActive", "type": "bool" }],"stateMutability": "view","type": "function"},{ "inputs": [], "name": "preSaleEndTime", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "preSaleEnded", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "b100dWhitelistStartTime", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "b100dWhitelistCloseTime", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "b100dStartTime", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "b100dCurrentDay", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "lastDistributionTime", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "lastPriceUpdateTime", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "bnbPrice", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "stateMutability": "view", "type": "function" },{ "inputs": [], "name": "token", "outputs": [{ "internalType": "contract IERC20", "name": "", "type": "address" }], "stateMutability": "view", "type": "function" }];

const publicSaleAbi = [// Oracle-called functions (Public Sale phase){ "inputs": [], "name": "startPublicSale", "outputs": [], "stateMutability": "nonpayable", "type": "function" },{"inputs": [],"name": "publicSaleStartTimestamp","outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],"stateMutability": "view","type": "function"}

];

// Instantiate contract objectsconst preSaleContract = new web3.eth.Contract(preSaleAbi, PRE_SALE_ADDRESS);const publicSaleContract = new web3.eth.Contract(publicSaleAbi, PUBLIC_SALE_ADDRESS);

// Loggerfunction log(msg, ...args) {const ts = new Date().toISOString();console.log([${ts}] ${msg}, ...args);}

// Statelet preSaleActive = true;let publicSaleActive = false;let whitelistOpened = false;let whitelistClosed = false;let b100dStarted = false;let lastPreSalePriceUpdate = 0;let lastPublicPriceUpdate = 0;let publicSaleStartTime = null;

// Bootstrapping(async () => {try {preSaleActive = !(await preSaleContract.methods.preSaleEnded().call());
...
// Oracle loopfunction startOracleLoops() {setInterval(async () => {const now = Math.floor(Date.now() / 1000);
...
try {
  ...
  console.error('Error fetching BNB price: PRICE_FETCH_FAILED');
}
...
// Fallbacksprocess.on('uncaughtException', (err) => console.error('Uncaught Exception:', err));process.on('unhandledRejection', (err) => console.error('Unhandled Promise Rejection:', err));
